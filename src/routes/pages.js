...
<html><head><title>Privacy Policy - Horizon Personal Loans</title>
...
<p><strong>Horizon Personal Loans (Demo)</strong></p>
...
router.get('/terms', (req, res) => {
  res.send(`<!DOCTYPE html>
<html><head><title>Terms of Service - Horizon Personal Loans</title>
<meta name="ai-funnel" content="/.well-known/ai-funnel.json">
<style>body{font-family:system-ui;max-width:700px;margin:40px auto;padding:0 20px;line-height:1.7;color:#1a2b4a}</style>
</head><body>
